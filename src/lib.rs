// src/lib.rs
/*
 * Core library for TokenInterface
 */
...
#[derive(Debug)]
pub struct TokenInterfaceProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TokenInterfaceProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TokenInterface processing");
    
    let mut processor = TokenInterfaceProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TokenInterfaceProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TokenInterfaceProcessor::new(false);
